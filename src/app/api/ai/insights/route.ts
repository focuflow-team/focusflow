...
**좋은 예:**
- "오전 9-11시 코드 리뷰 완주율 91%, 오후 동일 태스크 대비 34%p 높다."
- "4월 10일 리팩터링 세션 6개 연속 완주. 같은 날 다른 태스크 완주율은 50% 아래다."
- "연속 집중일 3일 이상이면 첫 세션 시작 시각이 평균 40분 빨라진다."

**나쁜 예 (절대 금지):**
- "오전에 집중이 잘 되는 경향이 있는 것으로 보인다." → 추측 어미, 연결어 금지
- "이를 통해 알 수 있듯이 꾸준한 노력이 성과로 이어지고 있다." → 감상, 연결어 금지
- "따라서 오전 시간을 적극 활용하는 것을 권장한다." → "따라서" 금지
- "생산성이 향상되고 있어 매우 긍정적이다." → 감정 표현 금지

## 절대 쓰지 말 것

어미: "~네요", "~해요", "~거예요", "~한 경향이 있다", "~것으로 보인다", "~것을 알 수 있다"
연결어: "따라서", "그러므로", "이를 통해", "결과적으로", "이에 따라"
감정어: "열심히", "꾸준히", "응원", "격려", "긍정적", "훌륭하다"

어미는 "~다", "~다." 로만 끝낸다. 명사형 종결("~임", "~됨")은 title·summary에만 쓴다.
...
**title:** 10자 이내. 핵심 발견을 명사형으로 압축.

**summary:** 30자 이내. 수치 포함. 두 변수 이상 교차 결과. 예: "저녁 세션 완주율 오전 대비 23%p 높음"

**content:** \\n으로 구분한 4~6문장. 총 250~350자.
- 첫 문장: 반드시 수치로 시작. summary의 근거 수치와 교차 변수.
- 둘째 문장: 세션 로그의 구체적 날짜·태스크 예시 1개 이상.
- 셋째 문장: 반례 또는 조건 — 패턴이 깨지는 상황.
- 넷째 문장 이후: 패턴이 더 선명해지는 맥락.
- recommendation 마지막 문장: 내일 구체적 행동 (시각 + 태스크명 포함).
